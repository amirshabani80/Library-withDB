...
public class BorrowDAO {
    ...
    public Integer borrowBook(BorrowDTO borrowDTO) throws SQLException {
        ...
        try {
            ...
            ps.setInt(1, borrowDTO.getBookId());
            ps.setInt(2, borrowDTO.getMemberId());
            ps.setString(3, borrowDTO.getBorrowDate());
            ps.setString(4, borrowDTO.getReturnDate());
            ps.executeUpdate();
            String updateSql = "UPDATE books SET status='BORROWED' WHERE id=?";
            updatePs = conn.prepareStatement(updateSql);
            updatePs.setInt(1, borrowDTO.getBookId());
    ...
    public List<BorrowDTO> showBorrowList() throws SQLException {
